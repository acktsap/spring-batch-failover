...
@Configuration
class ExceptionHandlerJobConfig(
    ...
    @Bean
    fun exceptionHandlerJob(): Job = batch {
        job("exceptionHandlerJob") {
            step("insertToTargetStep") {
                chunk<Customer, TargetCustomer>(3, transactionManager) {
                    ...
                    exceptionHandler { _, t ->
                        logger.info(t) { "Error occurred in chunk. Cleanup data" }
